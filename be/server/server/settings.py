...
SECRET_KEY = os.environ.get(
    "DJANGO_SECRET_KEY",
    "django-insecure-^97oiv%1x-u6b945x54b&62r$pg+q6aiz%b0)q*1=_xeazi%6)",
)
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "user.serializers.CustomTokenObtainPairSerializer",  # Custom Token Serializer
